...
public record MemoryEstimate(
    ...
    public static MemoryEstimate estimate(SimulationConfig config, long defaultBudgetBytes) {
        ...
        try {
            ...
            /// Byte mask + int obstacle ID per cell, compact deterministic result slots per batch,
            ...
            /// Private frame and compact result force slots plus pending/completed driver force storage.
