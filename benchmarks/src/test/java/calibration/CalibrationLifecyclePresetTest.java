...
class CalibrationLifecyclePresetTest {
    ...
    void lifecyclePresetIsAnOtherwiseIdenticalPolicyByLifecycleTwoByTwo() throws Exception {
        ...
        HarnessConfig harness = CalibrationRunner.loadConfig(
                "src/test/resources/calibration-presets/experiments/02-productivity-lifecycle-2x2.json", mapper);
        ...
        ComparisonConfig comparison = mapper.readValue(
                new File("src/test/resources/calibration-presets/comparisons/02-productivity-lifecycle-2x2.json"),
