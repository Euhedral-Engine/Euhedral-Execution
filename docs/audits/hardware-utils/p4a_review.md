...
|----|------------------------|----------------------------------------------------------------------------------------------------------|
| C1 | **CRITICAL**           | Period x1000 conversion applied to ALL profiles - must be LINUX_V2_LEGACY only                           |
...
| `CpuSlowSignals`: 6 fields (capacity units x2, frequency x2, thermal, low-power)    | SATISFIED |                                            |
...
erroneously multiplies by 1000, producing a period 1000x too large.
...
| Priority | Fix                                                                                                                        | Status |
|----------|----------------------------------------------------------------------------------------------------------------------------|--------|
| C1       | Gate `x1000` period conversion on `LINUX_V2_LEGACY` only                                                                   | Fixed  |
