...
public final class ControlPlaneFragment extends WorkRequester {
  ...
  static {
    try {
      ...
      ADAPTIVE_BATCH_CAP =
          MethodHandles.lookup()
              .findVarHandle(ControlPlaneFragment.class, "adaptiveBatchCap", long.class);
  ...
  @Getter private final FragmentConfig config;
      ...
      this.mainExecutor.execute(
          () -> {
            ...
            if (this.core != origin.core()) {
              ...
              this.logger.debug(
                  "Pinned to Core {} CPU {} P-Core: {}", this.core, this.cpu, this.isPCore);
            }
