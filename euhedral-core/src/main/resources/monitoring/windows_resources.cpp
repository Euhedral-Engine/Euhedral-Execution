...
Java_euhedral_io_resource_1monitoring_providers_WindowsResource_getCpuQuota(JNIEnv* env, jclass clazz) {
    BOOL inJob = FALSE;
...
Java_euhedral_io_resource_1monitoring_providers_WindowsResource_getAffinityMask(JNIEnv* env, jclass clazz) {
...
Java_euhedral_io_resource_1monitoring_providers_WindowsResource_getPerCpuLoad(JNIEnv* env, jclass clazz) {
...
JNIEXPORT jlongArray JNICALL
Java_euhedral_io_resource_1monitoring_providers_WindowsResource_getMemorySnapshot(JNIEnv* env, jclass clazz) {
...
JNIEXPORT jlong JNICALL
Java_euhedral_io_resource_1monitoring_providers_WindowsResource_getIoBytes(JNIEnv* env, jclass clazz) {
    IO_COUNTERS io;
