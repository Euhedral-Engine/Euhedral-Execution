...
cma = r'''package io.euhedral_execution.training.optimization;
...
bands = r'''package io.euhedral_execution.training.optimization;
...
Path("euhedral-training/src/main/java/io/euhedral_execution/training/optimization").mkdir(parents=True, exist_ok=True)
Path("euhedral-training/src/main/java/io/euhedral_execution/training/optimization/CmaEsOptimizer.java").write_text(cma)
Path("euhedral-training/src/main/java/io/euhedral_execution/training/optimization/ScoreBandSampler.java").write_text(bands)

seq = Path("euhedral-training/src/main/java/io/euhedral_execution/training/SequenceFinder.java")
text = seq.read_text()
text = text.replace("import io.euhedral_execution.training.networks.PolicyOrdinalNetwork;\n",
...
''', 1)
start = text.index("    public void generate(Path historicalData, Path output, int candidateCount, int sobolSkip)\n")
end = text.index("    public void train() throws Exception {\n", start)
replacement = r'''    public void generate(Path historicalData, Path output, int candidateCount, int sobolSkip)
            throws Exception {
