...
public record CalibrationConfig(
    ...
    public CalibrationConfig {
        if (minimumStrongAnchors < minimumWeakAnchors
                || minimumWeakAnchors < 1
                ...
                || maximumStrongResidual < 0
                || maximumWeakResidual < maximumStrongResidual
                || minimumLogSigma <= 0
                || maximumAnchorWeightShare <= 0
