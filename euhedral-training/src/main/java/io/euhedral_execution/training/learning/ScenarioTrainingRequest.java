...
public record ScenarioTrainingRequest(Phase1ScenarioInputs phase1Inputs,
        SortedSet<SourceScenario> requiredScenarios, Path modelDirectory, String commitSha,
        boolean dirtyWorkingTree, ScenarioTrainingConfig config) {
    public ScenarioTrainingRequest {
        Objects.requireNonNull(phase1Inputs);
