...
public record EvaluationSummaryMetadata(String groupedReport, String losoReport,
        OptionalDouble groupedMacroMae, OptionalDouble groupedMacroSpearman,
        OptionalDouble groupedMacroPrecisionAtTen, OptionalDouble losoMacroMae,
        OptionalDouble losoMacroSpearman, OptionalDouble losoWorstScenarioMae) {
