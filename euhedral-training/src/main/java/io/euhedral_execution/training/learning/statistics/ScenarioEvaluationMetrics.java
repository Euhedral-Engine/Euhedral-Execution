...
public record ScenarioEvaluationMetrics(String evaluationKind, String foldId,
                                        ...
                                        int rowCount, int policyCount,
                                        double mae, double rmse, double meanBias,
                                        OptionalDouble spearman,
                                        int actualTopDecileCount, int selectedCount,
                                        OptionalDouble precisionAtTen,
                                        OptionalDouble recallAtTen, double meanIntervalWidth,
    ...
    public ScenarioEvaluationMetrics {
        ...
        if (policyCount < 1 || policyCount > rowCount
