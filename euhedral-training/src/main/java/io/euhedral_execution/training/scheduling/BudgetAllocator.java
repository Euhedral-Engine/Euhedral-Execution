...
public final class BudgetAllocator {
    ...
    public static BudgetAllocation allocate(int candidateBudget, int fixedAnchorCount, CandidateBudgetConfig config) {
        ...
        int[] parts = HamiltonAllocator.allocate(
                residual,
                new int[] {
                ...
                TIE_ORDER);
        return new BudgetAllocation(fixedAnchorCount, parts[NEW], parts[CARRY], parts[LEADER], parts[AUDIT]);
    }
}
