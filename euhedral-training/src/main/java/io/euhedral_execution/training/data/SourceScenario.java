...
public record SourceScenario(String environmentId, int sourceCount, int availablePhysicalCoreCount, SourceRatio ratio)
        implements Comparable<SourceScenario> {
    ...
    public static SourceScenario of(String environmentId, int sourceCount, int coreCount) {
        return new SourceScenario(environmentId, sourceCount, coreCount, SourceRatio.of(sourceCount, coreCount));
    }
