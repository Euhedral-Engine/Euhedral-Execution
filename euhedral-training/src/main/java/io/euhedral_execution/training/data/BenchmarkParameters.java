...
public record BenchmarkParameters(int expectedRepetitions, long sampleDurationNanos,
                                  long livenessTimeoutNanos, int framesPerSource,
                                  long resetTimeoutNanos, boolean orderedFrames, String cpuSetHex,
    ...
    public BenchmarkParameters {
        ...
        if (expectedRepetitions < 1 || expectedRepetitions > 999_999 || sampleDurationNanos <= 0
                || livenessTimeoutNanos <= 0 || framesPerSource <= 0 || resetTimeoutNanos <= 0
