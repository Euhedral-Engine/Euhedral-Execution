...
def load_trial_config(config_path: Path) -> TrialConfig:
    ...
    cal_config = TrialCalibrationConfig(
        ...
        contention_half_life_nanos=int(
            cal_raw.get("contentionHalfLifeNanos", 1_000_000)),
...
class CompatibilityAnalyzer:
    ...
    def check_compatibility(
        ...
        if cal_a.contention_half_life_nanos != cal_b.contention_half_life_nanos:
            reasons.append("Mismatched contentionHalfLifeNanos")
