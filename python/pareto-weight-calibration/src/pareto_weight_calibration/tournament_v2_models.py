...
class ControlledSecondOrder(TransformerMixin, BaseEstimator):
  ...
  def transform(self, x):
    from .feature_schema import FeatureSchema, participation_basis
    from .direct_side import BASE_FEATURES
    return FeatureSchema(BASE_FEATURES,
                         participation_basis(self.geometry)).expand(x)
