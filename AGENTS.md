...
- P7 is in progress.
  ...
  - Child P7-C (Affinity, Timer & Native ABI) implementation is complete ([`phase-7-macos-affinity-native.md`](docs/blueprints/hardware-utils/phase-7-macos-affinity-native.md)).
