...
@Testcontainers
public class ContainerAwareResourceMonitorTest {

    private static final String RUNNER = "euhedral.common.io.dispatch.utils.ContainerAwareResourceMonitorTest$TestRunner";
    ...
    public static class TestRunner {
        ...
        static void main() throws InterruptedException {
            ContainerAwareResourceMonitor monitor = new ContainerAwareResourceMonitor(
                    Duration.ofMillis(50), Schedulers.boundedElastic());
